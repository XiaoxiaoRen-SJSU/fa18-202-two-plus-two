...
public class ThiefRight extends Thief implements IThiefState {
    ...
    public ThiefRight(int diamonds, int lives) {
        this.countOfDiamond = diamonds;
        this.lives = lives;
        backgroundMusic.playLoop();
    }
    
    public static ThiefRight getThief() {
        if (thief == null) {
            thief = new ThiefRight();
        }
        return thief;
    }
    // Singleton ends here
    ...
    public void nextState() {
        ThiefLeft thiefLeft = new ThiefLeft(countOfDiamond, lives);
        int x = this.getX();
        int y = this.getY();
        getWorld().removeObject(this);
        thiefLeft.setLocation(x, y);
    }
}
